...
AUTHORITY_URL_USERLEGACY = 'https://login.microsoftonline.com/{}'.format(TENANT_ID_USERLEGACY)
...
# CLIENT
TOKEN_URL_DEV_CLIENT = "TBA"
SCOPE_DEV_CLIENT = ["TBA"]

TOKEN_URL_TEST_CLIENT = "https://login.microsoftonline.com/4subseaid.onmicrosoft.com/oauth2/v2.0/token"
SCOPE_TEST_CLIENT = ["https://4subseaid.onmicrosoft.com/reservoir-test/.default"]

TOKEN_URL_QA_CLIENT = "https://login.microsoftonline.com/4subseaid.onmicrosoft.com/oauth2/v2.0/token"
SCOPE_QA_CLIENT = ["https://4subseaid.onmicrosoft.com/reservoir-qa/.default"]

TOKEN_URL_PROD_CLIENT = "https://login.microsoftonline.com/4subseaid.onmicrosoft.com/oauth2/v2.0/token"
