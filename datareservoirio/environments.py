...
class Environment(object):
    ...
    def set_production(self):
        ...
        self._set_application_insight_connectionstring(_constants.APPLICATIONINSIGHTS_PROD_CONNECTIONSTRING)

    def set_qa(self):
        self._set_environment(_constants.ENV_QA)
        self._set_base_url(_constants.API_BASE_URL_QA)
        self._set_application_insight_connectionstring(_constants.APPLICATIONINSIGHTS_QA_CONNECTIONSTRING)

    def set_test(self):
        self._set_environment(_constants.ENV_TEST)
        self._set_base_url(_constants.API_BASE_URL_TEST)
        self._set_application_insight_connectionstring(_constants.APPLICATIONINSIGHTS_TEST_CONNECTIONSTRING)

    def set_dev(self):
        self._set_environment(_constants.ENV_DEV)
        self._set_base_url(_constants.API_BASE_URL_DEV)
        self._set_application_insight_connectionstring(_constants.APPLICATIONINSIGHTS_DEV_CONNECTIONSTRING)
    ...
    def _set_application_insight_connectionstring(self, app_insights_connetionstring):
        self._logger.info(f"Setting application insights connectionstring to: {app_insights_connetionstring}")
